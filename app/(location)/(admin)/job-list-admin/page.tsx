...
import { CustomPagination } from "@/modules/job-list-admin/components/pagination";
import { TableSearchBar } from "@/modules/job-list-admin/components/searchbar";
import { CtvJobListTable } from "@/modules/job-list-admin/sections/CtvJobListTable";
    ...
    >
      ...
      <Box mt="25px">
        <Box display="flex" flexDirection="row" gap="30px">
          ...
          <Button
            sx={TabButtonStyle()}
            onClick={() => changeState("reviewing")}
          >
            <Typography
              sx={TabTextStyle(searchParams.get("state") === "reviewing")}
            >
              ĐANG DUYỆT
            </Typography>
          </Button>
          ...
          <Button
            sx={TabButtonStyle()}
            onClick={() => changeState("recruiting")}
          >
            <Typography
              sx={TabTextStyle(searchParams.get("state") === "recruiting")}
            >
              ĐANG TUYỂN
            </Typography>
          </Button>
          <Divider orientation="vertical" flexItem />
          <Button sx={TabButtonStyle()} onClick={() => changeState("paused")}>
            <Typography
              sx={TabTextStyle(searchParams.get("state") === "paused")}
            >
              TẠM DỪNG
            </Typography>
          </Button>
