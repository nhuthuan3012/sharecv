"use client";
import {
  getAdminMatchingCVResult,
  getCTVMatchingCVResult,
} from "@/common/apis/ai_result";
import { ICvMatchingResult } from "@/interfaces/ai-results";
import {
  detailPointTextStyles,
  header1Styles,
  headerStyles,
  percentageTextStyles,
} from "@/modules/ai-result/styles";
...
function AIResultPage({ params }: { params: { slug: string } }) {
  ...
  const [cvMatchingDetail, setCVMatchingDetail] = useState<ICvMatchingResult>(
    initialCVMatchingDetail
  );
          ...
          <Grid container spacing={3}>
              ...
              <Paper style={{ padding: 16 }}>
                ...
                >
                  <Box sx={{}} paddingLeft="50%">
                    <Typography sx={percentageTextStyles()}>
                      {cvMatchingDetail.match_data.overall.score}%
                    </Typography>
                  </Box>
                  <PieChart
                    series={[
                ...
                >
                  ...
                  >
                    <Box>
                      <Box>
                        <Typography sx={detailPointTextStyles()}>
                          Vị trí công việc
                        </Typography>
                      </Box>
                      <Box sx={{ position: "relative", marginTop: "20px" }}>
                        <LinearProgressWithLabel
                          value={cvMatchingDetail.match_data.job_title.score}
                          isMatched={isMatched}
                        />
                      </Box>
                    </Box>
                    <Box>
                      ...
                      <Box sx={{ position: "relative", marginTop: "20px" }}>
                        <LinearProgressWithLabel
                          value={cvMatchingDetail.match_data.experience.score}
                          isMatched={isMatched}
                        />
                      </Box>
                    </Box>
                    <Box>
                      ...
                      <Box sx={{ position: "relative", marginTop: "20px" }}>
                        <LinearProgressWithLabel
                          value={cvMatchingDetail.match_data.skill.score}
                          isMatched={isMatched}
                        />
                      </Box>
                    </Box>
                    <Box>
                      ...
                      <Box sx={{ position: "relative", marginTop: "20px" }}>
                        <LinearProgressWithLabel
                          value={cvMatchingDetail.match_data.education.score}
                          isMatched={isMatched}
                        />
                      </Box>
                    </Box>
                    <Box>
                      ...
                      <Box sx={{ position: "relative", marginTop: "20px" }}>
                        <LinearProgressWithLabel
                          value={cvMatchingDetail.match_data.orientation.score}
                          isMatched={isMatched}
                        />
                      </Box>
                    </Box>
                ...
                {isMatched ? (
                    ...
                    >
                      ...
                      <Box mt="25px">
                        <Typography className="text-white text-justify font-montserrat text-base font-medium leading-7">
                          Hệ thống đã gửi email xác nhận đến Ứng viên! Vui lòng
                          liên lạc Ứng viên xác nhận ứng tuyển vị trí.
                        </Typography>
                      </Box>
                    </Box>
                  </Paper>
                  ...
                  >
                    ...
                    >
                      ...
                      <Box mt="25px">
                        <Typography className="text-white text-justify font-montserrat text-base font-medium leading-7">
                          Hồ sơ chưa đạt yêu cầu kiểm duyệt của AI! Bạn có thể{" "}
                          <a
                            className="text-green-500 font-montserrat text-base font-medium leading-7 underline"
                            style={{ cursor: "pointer" }}
                          >
                            {" "}
                            chỉnh sửa{" "}
                          </a>{" "}
                          lại phù hợp với yêu cầu công việc hơn.
                        </Typography>
                      </Box>
                    </Box>
                  </Paper>
            ...
            <Grid item xs={6}>
              <Paper style={{ padding: 16 }}>
                ...
                >
                  <Box className="text-blue-900 font-montserrat text-2xl font-semibold">
                    Tổng quan
                  </Box>
                  <Box>
                ...
                >
                  ...
                  >
                    ...
                    >
                      <Box>
                        <Typography
                          className="text-gray-600 font-montserrat text-xl font-semibold"
                          sx={{ color: "#868686" }}
                        >
                          Vị trí công việc
                        </Typography>
